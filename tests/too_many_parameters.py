...
class MoneyModel(mesa.Model):
    def __init__(self, n=10, capacity=50, boolean=True, selection="none", text="none", seed=None, noneed1=0, noneed2=0,
                 noneed3=0, noneed4=0, noneed5=0):
...
model_params = {
    ...
    "noneed1": mesa_user_param.Slider("noneed:", 1, 0, 100, 1),
    "noneed2": mesa_user_param.Slider("noneed:", 1, 0, 100, 1),
    "noneed3": mesa_user_param.Slider("noneed:", 1, 0, 100, 1),
    "noneed4": mesa_user_param.Slider("noneed:", 1, 0, 100, 1),
    "noneed5": mesa_user_param.Slider("noneed:", 1, 0, 100, 1),
}
